...
namespace Rover.Controllers
{
    public class UnitTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UnitTypeID,UnitDesc")] UnitType unitType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UnitTypeID,UnitDesc")] UnitType unitType)
        {
            if (ModelState.IsValid)
            {
